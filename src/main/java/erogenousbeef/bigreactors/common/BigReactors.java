...
public class BigReactors {
    ...
    private static final String[] LANGUAGES_SUPPORTED = new String[] { "de_DE", "en_US", "es_SP", "nl_NL", "pl_PL",
    ...
    public static void register(Object modInstance) {
        ...
        if (!INITIALIZED) {
            ...
            enableWorldRegeneration = BRConfig.CONFIGURATION.get(
                ...
                .getBoolean(false);
            userWorldGenVersion = BRConfig.CONFIGURATION.get(
                "WorldGen",
                "userWorldGenVersion",
                0,
                "User-set world generation version. Increase this by 1 if you want Big Reactors to re-run world generation in your world.")
                .getInt();
            int[] worldGenDimensionWhitelist = BRConfig.CONFIGURATION.get(
                "WorldGen",
                "dimensionWhitelist",
                new int[] {},
                "If enableWorldGenInNegativeDimensions is false, you may add negative dimensions to this whitelist to selectively enable worldgen in them.")
                .getIntList();
            for (int i : worldGenDimensionWhitelist) {
                dimensionWhitelist.add(i);
            }

            boolean registerCoalFurnaceRecipe = BRConfig.CONFIGURATION.get(
                "Recipes",
                "registerCoalForSmelting",
                true,
                ...
                .getBoolean(true);
            boolean registerCharcoalFurnaceRecipe = BRConfig.CONFIGURATION.get(
                "Recipes",
                "registerCharcoalForSmelting",
                true,
                ...
                .getBoolean(true);
            boolean registerCoalCraftingRecipe = BRConfig.CONFIGURATION.get(
                "Recipes",
                "registerGraphiteCoalCraftingRecipes",
                false,
                ...
                .getBoolean(false);
            boolean registerCharcoalCraftingRecipe = BRConfig.CONFIGURATION.get(
                "Recipes",
                "registerGraphiteCharcoalCraftingRecipes",
                false,
                ...
                .getBoolean(false);
            registerYelloriteSmeltToUranium = BRConfig.CONFIGURATION.get(
                "Recipes",
                "registerYelloriteSmeltToUranium",
                true,
            ...
            boolean useSteelForIron = BRConfig.CONFIGURATION.get(
                "Recipes",
                "requireSteelInsteadOfIron",
                false,
                ...
                .getBoolean(false);
            boolean useExpensiveGlass = BRConfig.CONFIGURATION.get(
                "Recipes",
                "requireObsidianGlass",
                false,
                "If set, then Big Reactors will require hardened or reinforced glass (blockGlassHardened or glassReinforced) instead of plain glass. Will be ignored if no other mod registers those glass types. (default: false)")
                .getBoolean(false);

            boolean enableReactorPowerTapRecipe = BRConfig.CONFIGURATION
                .get(
                    "Recipes",
                    "enableReactorPowerTapRecipe",
                    true,
                    "If set, reactor power taps can be crafted, allowing players to use passive-cooled reactors.")
                .getBoolean(true);
            boolean enableCyaniteFromYelloriumRecipe = BRConfig.CONFIGURATION
                .get(
                    "Recipes",
                    "enableCyaniteFromYelloriumRecipe",
                    true,
                    "If set, cyanite will be craftable from yellorium ingots and sand.")
                .getBoolean(true);

            maximumReactorSize = BRConfig.CONFIGURATION.get(
                "General",
                "maxReactorSize",
                32,
                ...
                .getInt();
            maximumReactorHeight = BRConfig.CONFIGURATION.get(
                "General",
                "maxReactorHeight",
                48,
                ...
                .getInt();
            ticksPerRedstoneUpdate = BRConfig.CONFIGURATION
                .get(
                    "General",
                    "ticksPerRedstoneUpdate",
                    20,
                    "Number of ticks between updates for redstone/rednet ports.")
                .getInt();
            powerProductionMultiplier = (float) BRConfig.CONFIGURATION
                .get(
                    "General",
                ...
                .getDouble(1.0);
            fuelUsageMultiplier = (float) BRConfig.CONFIGURATION
                .get(
                    "General",
                    "fuelUsageMultiplier",
                    1.0f,
                    "A multiplier for balancing fuel consumption. Defaults to 1.")
                .getDouble(1.0);

            reactorPowerProductionMultiplier = (float) BRConfig.CONFIGURATION.get(
                "General",
                "reactorPowerProductionMultiplier",
                1.0f,
                "A multiplier for balancing reactor power production. Stacks with powerProductionMultiplier. Defaults to 1.")
                .getDouble(1.0);
            turbinePowerProductionMultiplier = (float) BRConfig.CONFIGURATION.get(
                "General",
                "turbinePowerProductionMultiplier",
                1.0f,
                "A multiplier for balancing turbine power production. Stacks with powerProductionMultiplier. Defaults to 1.")
                .getDouble(1.0);

            maximumTurbineSize = BRConfig.CONFIGURATION.get(
                "General",
                "maxTurbineSize",
                16,
                "The maximum valid size of a turbine in the X/Z plane, in blocks. Lower this for smaller turbines, which means lower max output.")
                .getInt();
            maximumTurbineHeight = BRConfig.CONFIGURATION
                .get(
                    "General",
                    "maxTurbineHeight",
                    32,
            ...
            turbineCoilDragMultiplier = (float) BRConfig.CONFIGURATION.get(
                "General",
                "turbineCoilDragMultiplier",
                1.0,
                "A multiplier for balancing coil size. Multiplies the amount of energy drawn per coil block per tick. (Default: 1)")
                .getDouble(1.0);
            turbineAeroDragMultiplier = (float) BRConfig.CONFIGURATION.get(
                "General",
                "turbineAeroDragMultiplier",
                1.0,
                "A multiplier for balancing rotor sizes. Multiplies the amount of energy lost to aerodynamic drag per tick. (Default: 1)")
                .getDouble(1.0);
            turbineMassDragMultiplier = (float) BRConfig.CONFIGURATION.get(
                "General",
                "turbineMassDragMultiplier",
                1.0,
                "A multiplier for balancing rotor sizes. Multiplies the amount of energy lost to friction per tick. (Default: 1)")
                .getDouble(1.0);
            turbineFluidPerBladeMultiplier = (float) BRConfig.CONFIGURATION.get(
                "General",
                "turbineFluidPerBladeMultiplier",
                1.0,
                "A multiplier for balancing coil size. Multiplies the amount of fluid each blade block can process (base of 25 will be multiplied, then rounded down to the nearest integer). (Default: 1)")
                .getDouble(1.0);

            MultiblockTurbine.inputFluidPerBlade = (int) Math
                .floor(MultiblockTurbine.inputFluidPerBlade * turbineFluidPerBladeMultiplier);
            ...
            if (blockYelloriteOre != null) {
                ...
                if (registerYelloriteSmeltToUranium) {
                    ...
                    if (candidateOres == null || candidateOres.size() <= 0) {
                        BRLog.warning(
                            "Config value registerYelloriteSmeltToUranium is set to True, but there are no ores registered as ingotUranium in the ore dictionary! Falling back to using standard yellorium only.");
                        candidateOres = OreDictionaryArbiter.getOres("ingotYellorium");
                    }
                    product = candidateOres.get(0)
                        .copy();
                } else {
                    product = OreDictionaryArbiter.getOres("ingotYellorium")
                        .get(0)
                        .copy();
                }
            ...
            if (blockMetal != null) {
                ...
                GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                        blockMetal.getItemStackForMaterial("Ludicrite"),
                        "BPB",
                        "ENE",
                        "BPB",
                        'N',
            ...
            ItemStack ingotGraphite = OreDictionaryArbiter.getOres("ingotGraphite")
                .get(0)
                .copy();
            ItemStack ingotCyanite = OreDictionaryArbiter.getOres("ingotCyanite")
                .get(0)
                .copy();
            ...
            if (blockYelloriumFuelRod != null) {
                GameRegistry.addRecipe(
                    new ShapedOreRecipe(
                        new ItemStack(blockYelloriumFuelRod, 1),
                        "ICI",
                        "IUI",
                        "ICI",
                        'I',
            ...
            if (blockMultiblockGlass != null) {
                ...
                if (useExpensiveGlass && (ItemHelper.oreNameExists("glassReinforced")
                    || ItemHelper.oreNameExists("blockGlassHardened"))) {
                    GameRegistry.addRecipe(
                        new ShapedOreRecipe(reactorGlassStack, "GCG", 'G', "glassReinforced", 'C', "reactorCasing"));
                    GameRegistry.addRecipe(
                        new ShapedOreRecipe(reactorGlassStack, "GCG", 'G', "blockGlassHardened", 'C', "reactorCasing"));

                    GameRegistry.addRecipe(
                        new ShapedOreRecipe(turbineGlassStack, "GCG", 'G', "glassReinforced", 'C', "turbineHousing"));
                    GameRegistry.addRecipe(
                        new ShapedOreRecipe(
                            turbineGlassStack,
                            "GCG",
            ...
            if (blockTurbineRotorPart != null) {
                ...
                GameRegistry
                    .addRecipe(new ShapedOreRecipe(rotorShaft, "ICI", 'C', "ingotCyanite", 'I', ironOrSteelIngot));
                GameRegistry
                    .addRecipe(new ShapedOreRecipe(rotorBlade, "CII", 'C', "ingotCyanite", 'I', ironOrSteelIngot));
            }
    ...
    public static void registerTileEntities() {
        if (!registeredTileEntities) {
            ...
            GameRegistry
                .registerTileEntity(TileEntityTurbineCreativeSteamGenerator.class, "BRTurbineCreativeSteamGenerator");
    ...
    public static ItemStack registerOres(int i, boolean b) {
        ...
        if (blockYelloriteOre == null) {
            ...
            OreDictionary.registerOre("oreUranium", yelloriteStack);
            OreDictionary.registerOre("oreYellorite", yelloriteStack);
            OreDictionary.registerOre("oreYellorium", yelloriteStack); // For convenience of mods which fiddle with
                                                                       // recipes
        }
        ...
        boolean genYelloriteOre = BRConfig.CONFIGURATION
            .get("WorldGen", "GenerateYelloriteOre", true, "Add yellorite ore during world generation?")
            .getBoolean(true);
        if (yelloriteOreGeneration == null && genYelloriteOre) {
            ...
            clustersPerChunk = BRConfig.CONFIGURATION
                .get(
                    "WorldGen",
                    "MaxYelloriteClustersPerChunk",
                    5,
                    "Maximum number of clusters per chunk; will generate at least half this number, rounded down")
                .getInt();
            orePerCluster = BRConfig.CONFIGURATION.get(
                "WorldGen",
                "MaxYelloriteOrePerCluster",
                10,
                "Maximum number of blocks to generate in each cluster; will usually generate at least half this number")
                .getInt();
            maxY = BRConfig.CONFIGURATION
                .get(
                    "WorldGen",
                    "YelloriteMaxY",
                    50,
                ...
                .getInt();
            int[] dimensionBlacklist = BRConfig.CONFIGURATION
                .get(
                    "WorldGen",
                    "YelloriteDimensionBlacklist",
                    new int[] {},
                    "Dimensions in which yellorite ore should not be generated; Nether/End automatically included")
                .getIntList();

            yelloriteOreGeneration = new BRSimpleOreGenerator(
                blockYelloriteOre,
                0,
                Blocks.stone,
                clustersPerChunk / 2,
            ...
            BRSimpleOreGenerator yelloriteOreGeneration2 = new BRSimpleOreGenerator(
                blockYelloriteOre,
                0,
                Blocks.stone,
                1,
    ...
    public static ItemStack registerIngots(int id) {
        if (BigReactors.ingotGeneric == null) {
            BRConfig.CONFIGURATION.load();
            registerYelloriumAsUranium = BRConfig.CONFIGURATION.get(
                "Recipes",
                "registerYelloriumAsUranium",
                true,
                "If set, yellorium will be registered in the ore dictionary as ingotUranium as well as ingotYellorium. Otherwise, it will only be registered as ingotYellorium. (Default: true)")
                .getBoolean(true);
    ...
    public static void registerReactorPartBlocks(int id, boolean require) {
        if (BigReactors.blockReactorPart == null) {
            ...
            OreDictionary
                .registerOre("reactorController", BigReactors.blockReactorPart.getReactorControllerItemStack());
        ...
        if (BigReactors.blockMultiblockGlass == null) {
            ...
            GameRegistry
                .registerBlock(BigReactors.blockMultiblockGlass, ItemBlockBigReactors.class, "BRMultiblockGlass");
    ...
    public static void registerTurbineParts() {
        ...
        if (BigReactors.blockTurbineRotorPart == null) {
            ...
            GameRegistry
                .registerBlock(BigReactors.blockTurbineRotorPart, ItemBlockBigReactors.class, "BRTurbineRotorPart");
    ...
    public static void registerDevices(int id, boolean require) {
        if (BigReactors.blockDevice == null) {
            ...
            OreDictionary.registerOre(
                "brDeviceCyaniteProcessor",
                ((BlockBRDevice) BigReactors.blockDevice).getCyaniteReprocessorItemStack());
    ...
    public static void registerCreativeParts(int id, boolean require) {
        ...
        boolean regCreativeParts = BRConfig.CONFIGURATION
            .get(
                "General",
                "registerCreativeMultiblockParts",
                true,
                "If true, creative parts for reactors, turbines and other multiblocks will be registered.")
            .getBoolean(true);
        if (regCreativeParts && BigReactors.blockMultiblockCreativePart == null) {
            ...
            GameRegistry.registerBlock(
                BigReactors.blockMultiblockCreativePart,
                ItemBlockBigReactors.class,
                "BRMultiblockCreativePart");
        }
    ...
    public static void registerFluids(int id, boolean require) {
        if (BigReactors.fluidYelloriumStill == null) {
            ...
            GameRegistry.registerBlock(
                BigReactors.fluidYelloriumStill,
                ItemBlock.class,
                BigReactors.fluidYelloriumStill.getUnlocalizedName());

            fluidYelloriumBucketItem = (new ItemBRBucket(liqY)).setUnlocalizedName("bucket.yellorium")
                .setMaxStackSize(1)
        ...
        if (BigReactors.fluidCyaniteStill == null) {
            ...
            GameRegistry.registerBlock(
                ...
                ItemBlock.class,
                BigReactors.fluidCyaniteStill.getUnlocalizedName());

            fluidCyaniteBucketItem = (new ItemBRBucket(liqDY)).setUnlocalizedName("bucket.cyanite")
                .setMaxStackSize(1)
                .setContainerItem(Items.bucket);
    ...
    protected static void registerGameBalanceData() {
        ...
        BRConfig.CONFIGURATION.load();
        boolean enableFantasyMetals = BRConfig.CONFIGURATION
            .get(
                "General",
                "enableMetallurgyFantasyMetalsInTurbines",
                true,
                "If true, allows Metallurgy's fantasy metals to be used as part of turbine coils. Default: true")
            .getBoolean(true);
        boolean enableComedy = BRConfig.CONFIGURATION
            .get(
                "General",
                "enableComedy",
                true,
        ...
        TurbineCoil.registerBlock("blockElectrumFlux", 2.5f, 1.01f, 2.2f); // Redstone Arsenal, note small energy bonus
                                                                           // (7% at 1000RF/t output)
        ...
        TurbineCoil.registerBlock("blockEnderium", 3.0f, 1.02f, 3.0f); // TE, note tiny energy bonus! (14% at 1000RF/t
                                                                       // output)
        ...
        ReactorInterior.registerBlock("blockGraphite", 0.10f, 0.50f, 2.00f, IHeatEntity.conductivityGold); // Graphite:
                                                                                                           // a great
                                                                                                           // moderator!
        ...
        ReactorInterior.registerFluid(
            "water",
            RadiationHelper.waterData.absorption,
            RadiationHelper.waterData.heatEfficiency,
            RadiationHelper.waterData.moderation,
            IHeatEntity.conductivityWater);
        ...
        ReactorInterior.registerFluid("cryotheum", 0.66f, 0.95f, 6.00f, IHeatEntity.conductivityDiamond); // Cryotheum:
                                                                                                          // an amazing
                                                                                                          // moderator!
        ...
        ReactorInterior.registerFluid("life essence", 0.70f, 0.55f, 1.75f, IHeatEntity.conductivityGold); // From Blood
                                                                                                          // Magic
