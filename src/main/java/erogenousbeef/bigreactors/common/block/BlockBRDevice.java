...
public class BlockBRDevice extends BlockCoFHBase {
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister) {
        ...
        for (int i = 0; i < _subBlocks.length; ++i) {
            ...
            _activeIcons[i] = par1IconRegister
                .registerIcon(BigReactors.TEXTURE_NAME_PREFIX + getUnlocalizedName() + "." + _subBlocks[i] + ".active");
        }
    }
    ...
    // IDismantleable
    @Override
    public ArrayList<ItemStack> dismantleBlock(EntityPlayer player, NBTTagCompound blockTag, World world, int x, int y,
