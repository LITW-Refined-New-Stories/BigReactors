...
public class FloatUpdateTracker {
    ...
    public FloatUpdateTracker(int minimumTicksBetweenUpdates, int minimumTicksBetweenUrgentUpdates,
        float minimumSpreadForUpdate, float maximumSpreadForUpdate) {
