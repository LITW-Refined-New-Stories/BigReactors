...
public class TileEntityTurbineCreativeSteamGenerator extends TileEntityTurbinePartStandard
    ...
    public void onMultiblockServerTick() {
        if (isConnected() && getTurbine().getActive()) {
            ...
            getTurbine()
                .fill(MultiblockTurbine.TANK_INPUT, new FluidStack(steam, getTurbine().getMaxIntakeRate()), true);
        }
    }
}
