...
public class TileEntityReactorPowerTap extends TileEntityReactorPart
    implements IEnergyProvider, INeighborUpdatableEntity {
    ...
    public int extractEnergy(ForgeDirection from, int maxExtract, boolean simulate) {
        ...
        if (from == getOutwardsDir()) {
            return this.getReactorController()
                .extractEnergy(from, maxExtract, simulate);
        }
