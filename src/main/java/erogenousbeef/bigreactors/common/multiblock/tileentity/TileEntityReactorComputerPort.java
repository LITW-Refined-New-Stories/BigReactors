...
public class TileEntityReactorComputerPort extends TileEntityReactorPart
    ...
    public Object[] callMethod(int method, Object[] arguments) throws Exception {
        ...
        switch (computerMethod) {
            ...
            case getHotFluidProducedLastTick:
                if (reactor.isPassivelyCooled()) return new Object[] { 0f };
                else return new Object[] { reactor.getEnergyGeneratedLastTick() };

            case isActivelyCooled:
                return new Object[] { !reactor.isPassivelyCooled() };

            case getCoolantAmount:
                return new Object[] { reactor.getCoolantContainer()
                    .getCoolantAmount() };
            ...
            case getCoolantType: {
                Fluid fluidType = reactor.getCoolantContainer()
                    .getCoolantType();
                if (fluidType == null) {
                    return null;
                } else {
            ...
            case getControlRodLocation: {
                ...
                return new Object[] { rodCoord.x - reactorMinCoord.x, rodCoord.y - reactorMinCoord.y,
            ...
            case setControlRodLevel:
                if (arguments.length < 2) {
                    throw new IllegalArgumentException(
                        "Insufficient number of arguments, expected 2 (control rod index, level)");
                }
            ...
            case setControlRodName:
                if (arguments.length < 2) {
                    throw new IllegalArgumentException(
                        "Insufficient number of arguments, expected 2 (control rod index, name)");
                }
    ...
    private CoordTriplet getControlRodCoordFromArguments(MultiblockReactor reactor, Object[] arguments, int index)
        throws Exception {
        ...
        if (index < 0 || index >= reactor.getFuelRodCount()) {
            throw new IndexOutOfBoundsException(
                String.format("Invalid argument %d, control rod index is out of bounds", index));
        }

        return reactor.getControlRodLocations()[rodIndex];
    }

    private TileEntityReactorControlRod getControlRodFromArguments(MultiblockReactor reactor, Object[] arguments,
