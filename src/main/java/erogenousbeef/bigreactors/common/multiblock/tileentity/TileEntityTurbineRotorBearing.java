...
public class TileEntityTurbineRotorBearing extends TileEntityTurbinePartStandard {
        ...
        if (worldObj.isRemote) {
            ...
            while (rotorPosition < rotorInfo.rotorLength) {
                ...
                for (int bladeIdx = 0; bladeIdx < dirsToCheck.length; bladeIdx++) {
                    ...
                    bladeLength = 0;
                    while (worldObj.getBlock(bladeCoord.x, bladeCoord.y, bladeCoord.z)
                        == BigReactors.blockTurbineRotorPart && bladeLength < 32) {
                        bladeLength++;
                        bladeCoord.translate(bladeDir);
                    }
