...
public abstract class TileEntityReactorPartBase extends RectangularMultiblockTileEntityBase
    implements IMultiblockGuiHandler, IHeatEntity, IRadiationModerator, IActivateable, IBeefDebuggableTile {
    ...
    public void setActive(boolean active) {
        if (isConnected()) {
            ...
            BRLog.error(
                "Received a setActive command at %d, %d, %d, but not connected to a multiblock controller!",
                xCoord,
                yCoord,
                zCoord);
        }
