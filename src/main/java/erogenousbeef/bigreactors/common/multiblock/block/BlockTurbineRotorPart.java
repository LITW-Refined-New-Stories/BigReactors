...
public class BlockTurbineRotorPart extends BlockContainer {
    ...
    private static final String[] _subBlocks = new String[] { "rotor", "blade", };
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister) {
        ...
        _subIcons[0] = par1IconRegister
            .registerIcon(BigReactors.TEXTURE_NAME_PREFIX + getUnlocalizedName() + ".rotor.connector");
    }
