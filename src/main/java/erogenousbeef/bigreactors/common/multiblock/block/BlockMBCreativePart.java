    ...
    public void registerBlockIcons(IIconRegister par1IconRegister) {
        ...
        for (int i = 0; i < subBlocks.length; ++i) {
            icons[i] = par1IconRegister
                .registerIcon(BigReactors.TEXTURE_NAME_PREFIX + getUnlocalizedName() + "." + subBlocks[i]);
        }

        for (int i = 0; i < subIconNames.length; ++i) {
            subIcons[i] = par1IconRegister
                .registerIcon(BigReactors.TEXTURE_NAME_PREFIX + getUnlocalizedName() + "." + subIconNames[i]);
        }
    }
