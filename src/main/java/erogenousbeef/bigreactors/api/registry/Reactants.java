...
public class Reactants {
    ...
    private static Set<ReactorSolidMapping> _reactorSolidToFuel = new CopyOnWriteArraySet<ReactorSolidMapping>(); // This
                                                                                                                  // won't
                                                                                                                  // work
    private static Set<ReactorSolidMapping> _reactorSolidToWaste = new CopyOnWriteArraySet<ReactorSolidMapping>(); // This
                                                                                                                   // won't
                                                                                                                   // work
     ...
     * 
     * @param itemStack    The item which represents a reactant. Its quantity indicates how many items will be used to
     *                     make 1000mB of reactant.
    ...
    public static SourceProductMapping registerSolid(ItemStack itemStack, String reactantName) {
        ...
        if (oreDictNames == null || oreDictNames.size() < 1) {
            BRLog.warning(
                "Reactants.registerSolid: Could not resolve ore dict name for %s",
     ...
     * 
     * @param itemStack    The item which represents a reactant. Its quantity indicates how many items will be used to
     *                     make the defined units of reactant.
     * @param reactantName The name of the reactant.
     ...
     * @return A. list of Reactant => OreDict mappings. Note that reactant is the source and OreDict names are the
     *         product.
     */
    ...
    //// HELPERS
    private static void mapReactant(String reactantName, SourceProductMapping mapping,
        Map<String, List<SourceProductMapping>> map) {
