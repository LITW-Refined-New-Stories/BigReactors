...
public class BRSimpleOreGenerator extends WorldGenMinable {
    ...
    public BRSimpleOreGenerator(Block blockToGenerate, int blockMetadata, Block blockToReplace, int clustersPerChunk,
        int maxY, int maxOrePerCluster) {
    ...
    public BRSimpleOreGenerator(Block blockToGenerate, int blockMetadata, Block blockToReplace, int minClustersPerChunk,
        int maxClustersPerChunk, int minY, int maxY, int maxOrePerCluster) {
        ...
        if (o instanceof BRSimpleOreGenerator) {
            ...
            if (this.blockToGenerate != null) {
                return this.blockToGenerate == other.blockToGenerate
                    && this.blockToGenerateMetadata == other.blockToGenerateMetadata;
