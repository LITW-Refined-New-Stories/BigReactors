...
public class ClientProxy extends CommonProxy {
    ...
    public void init() {
        ...
        FMLCommonHandler.instance()
            .bus()
            .register(new BRRenderTickHandler());
        ...
        if (BigReactors.blockTurbinePart != null) {
            ClientRegistry
                .bindTileEntitySpecialRenderer(TileEntityTurbineRotorBearing.class, new RotorSpecialRenderer());
        }
    }
    ...
    public void registerIcons(TextureStitchEvent.Pre event) {
        ...
        Set<MultiblockControllerBase> controllers = MultiblockRegistry.getControllersFromWorld(
