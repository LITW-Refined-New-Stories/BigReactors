...
public class StaticUtils {
    ...
    public static final ForgeDirection[] CardinalDirections = new ForgeDirection[] { ForgeDirection.NORTH,
    ...
    public static class Inventory {
        ...
        public static boolean isPlayerHoldingWrench(EntityPlayer player) {
            ...
            Item currentItem = player.inventory.getCurrentItem()
                .getItem();
    ...
    public static class Fluids {
            ...
            if (fluid != null) {
                if (handler.fill(ForgeDirection.UNKNOWN, fluid, false) == fluid.amount
                    ...
                    if (!player.capabilities.isCreativeMode) {
                        player.inventory
                            .setInventorySlotContents(player.inventory.currentItem, Inventory.consumeItem(container));
                    }
                    return true;
                }
            }
        ...
        public static boolean fillContainerFromTank(World world, IFluidHandler handler, EntityPlayer player,
        ...
        public static String formatRF(float number) {
            ...
            if (divisor > 0) {
                return String.format(
                    "%s%." + Integer.toString(decimalPoints) + "f %sRF",
                    prefix,
                    number / divisor,
