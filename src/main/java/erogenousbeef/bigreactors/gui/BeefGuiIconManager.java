...
public class BeefGuiIconManager extends BeefIconManager {
    ...
    protected String[] getIconNames() {
        return new String[] { "coolantIn", "coolantOut", "coolantTemperature", "energyOutput", "fuelUsageRate",
            "hotFluidIn", "hotFluidOut", "Off_off", "Off_on", "On_off", "On_on", "temperature", "wasteEject_off",
            "wasteEject_on", "wasteManual_off", "wasteManual_on", "wasteEject", "reactivity", "energyStored", "rpm",
            "upArrow", "downArrow", "fuelEject", "inletOn", "inletOff", "outletOn", "outletOff", "ventAllOff",
            "ventAllOn", "ventOverflowOff", "ventOverflowOn", "ventNoneOff", "ventNoneOn", "rotorEfficiency",
