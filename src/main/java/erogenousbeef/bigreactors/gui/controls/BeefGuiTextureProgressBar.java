...
public abstract class BeefGuiTextureProgressBar extends BeefGuiVerticalProgressBar {
    ...
    protected void drawProgressBar(Tessellator tessellator, TextureManager renderEngine, int barMinX, int barMaxX,
        ...
        if (getProgress() > 0.00001) {
            barHeight = Math.max(getBarMinHeight(), barHeight);
        }
        ...
        tessellator
            .addVertexWithUV(this.absoluteX + this.width, this.absoluteY + this.height, zLevel, barRightU, barMaxV);
        tessellator.addVertexWithUV(
            ...
            barMinV);
        tessellator
            .addVertexWithUV(this.absoluteX, this.absoluteY + this.height - barHeight, zLevel, barLeftU, barMinV);
        tessellator.draw();
    }
