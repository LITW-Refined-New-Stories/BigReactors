...
public class BeefGuiRpmBar extends BeefGuiTextureProgressBar implements IBeefTooltipControl {
    ...
    public BeefGuiRpmBar(BeefGuiBase container, int x, int y, MultiblockTurbine turbine, String tooltipTitle,
        String[] extraTooltip) {
        super(container, x, y);
        tooltip = null;
    ...
    protected float getProgress() {
        ...
        return Math.min(1f, turbine.getRotorSpeed() / (turbine.getMaxRotorSpeed() * 1.1f)); // Give a little extra
                                                                                            // warning
    }
