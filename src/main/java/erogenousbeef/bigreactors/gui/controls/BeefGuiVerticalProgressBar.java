...
public abstract class BeefGuiVerticalProgressBar extends BeefGuiControlBase {
    ...
    protected abstract void drawProgressBar(Tessellator tessellator, TextureManager renderEngine, int barMinX,
        int barMaxX, int barMinY, int barMaxY, int zLevel);
    ...
    public void drawBackground(TextureManager renderEngine, int mouseX, int mouseY) {
        ...
        tessellator
            .addVertexWithUV(this.absoluteX + this.width, this.absoluteY + this.height, 0, backgroundRightU, 1.0);
        ...
        if (drawGradationMarks()) {
            ...
            tessellator.addVertexWithUV(
                this.absoluteX + this.width - 4,
                this.absoluteY + this.height,
                2,
                gradationRightU,
                1.0);
