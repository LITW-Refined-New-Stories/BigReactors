...
public class BeefGuiRedNetChannelSelector extends BeefGuiControlBase implements IBeefGuiControl, IBeefTooltipControl {
     ...
     * @param container
     * @param caption
     * @param colorIdx  Index of the channel, also the color index in the EntitySheep color table. (Always 100%
     *                  opacity.)
     * @param x
     * @param y
     * @param width
     * @param height
     */
    public BeefGuiRedNetChannelSelector(BeefGuiBase container, String caption, int colorIdx, int x, int y, int width,
        int height) {
