...
public class TileMessageServer<TE extends TileEntity> extends WorldMessageServer {
    ...
    protected abstract static class Handler<MESSAGE extends TileMessageServer, TE extends TileEntity>
        extends WorldMessageServer.Handler<MESSAGE> {
        ...
        protected IMessage handleMessage(MESSAGE message, MessageContext ctx, TileEntity te) {
            ...
            if (concrete != null) {
                ...
                BRLog.error(
                    "Received a TileMessageServer for a non-resolvable TileEntity @ %d, %d, %d",
                    message.x,
                    message.y,
                    message.z);
            }
