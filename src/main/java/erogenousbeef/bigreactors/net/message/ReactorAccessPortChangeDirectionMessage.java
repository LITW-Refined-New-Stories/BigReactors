...
public class ReactorAccessPortChangeDirectionMessage extends TileMessageServer<TileEntityReactorAccessPort> {
    ...
    public static class Handler
        extends TileMessageServer.Handler<ReactorAccessPortChangeDirectionMessage, TileEntityReactorAccessPort> {

        @Override
        protected IMessage handle(ReactorAccessPortChangeDirectionMessage message, MessageContext ctx,
            TileEntityReactorAccessPort te) {
