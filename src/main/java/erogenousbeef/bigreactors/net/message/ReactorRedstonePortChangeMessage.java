...
public class ReactorRedstonePortChangeMessage extends TileMessageServer<TileEntityReactorRedstonePort> {
    ...
    public ReactorRedstonePortChangeMessage(TileEntityReactorRedstonePort port, int newCircut, int newLevel,
        boolean newGt, boolean pulse) {
        super(port);
    ...
    public static class Handler
        extends TileMessageServer.Handler<ReactorRedstonePortChangeMessage, TileEntityReactorRedstonePort> {

        @Override
        public IMessage handle(ReactorRedstonePortChangeMessage message, MessageContext ctx,
        ...
        public TileEntityReactorRedstonePort getImpl(TileEntity te) {
            return te instanceof TileEntityReactorRedstonePort ? (TileEntityReactorRedstonePort) te : null;
        }
    }
}
