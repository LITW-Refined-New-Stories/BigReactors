...
public class ReactorCommandEjectToPortMessage extends ReactorMessageServer {
    ...
    public ReactorCommandEjectToPortMessage(TileEntityReactorAccessPort destination, boolean ejectFuel,
        boolean dumpExcess) {
    ...
    public static class Handler extends ReactorMessageServer.Handler<ReactorCommandEjectToPortMessage> {
        ...
        @Override
        public IMessage handleMessage(ReactorCommandEjectToPortMessage message, MessageContext ctx,
