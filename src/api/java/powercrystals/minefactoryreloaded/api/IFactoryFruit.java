...
public interface IFactoryFruit {
    ...
    /**
     * @return Whether or not the Fruit Picker should break the block when harvesting. If false, no changes will be
     *         performed by the Fruit Picker itself.
     */
    public boolean breakBlock();

    /**
     * Called by the Fruit Picker to determine what block to replace the picked block with. Only ID and meta/damage will
     * be used.
    ...
    /**
     * Called by the Fruit Picker to determine what drops to generate. At the time this method is called, the fruit
     * still exists.
     * 
     * @param world The world where the fruit is being picked
     * @param x     The x-coordinate of the fruit
